    ...
    return <div className=" bg-black  w-full text-[#006A67] min-h-full ">
        ...
        <main className="flex justify-center">
            ...
            <div className="fixed flex justify-center left-2/6 right-2/6 top-5/6 ">
                ...
                <div className="h-25 flex flex-col p-2  bg-black min-w-[500px] border-2 border-[#303030] md:max-w-[700px] rounded-4xl flex flex-wrap">
                    ...
                    }}className="outline-none mt-1 whitespace-normal rounded-4xl w-[400px] p-5 max-h-30 overflow-hidden  resize-none "/>
